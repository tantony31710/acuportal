# Project Roadmap: 4-Track Master Architecture

This document tracks progression across all 9 domains to ensure professional, holistic development.

## 1. Data & AI Tracks

| Track | Core Progression |
| :--- | :--- |
...
| Track | Core Progression |
| :--- | :--- |
| **Full Stack** | HTML/CSS/JS Basics → Git/GitHub → Frontend Frameworks (React/Tailwind) → Backend (Node.js/Python) → API Design → Databases (SQL/NoSQL) → DevOps (AWS/Linux/CI/CD). |
| **React** | Basics (Must-do) → Component Basics (JSX/Props/State) → Hooks (useState/useEffect) → Routing → State Management → Styling → API Calls/Fetching → Testing → Next.js. |
| **Cyber Security** | IT Fundamentals (OS/Networking) → Linux/Windows Admin → Security Fundamentals (CIA Triad) → Penetration Testing → Cryptography → Threat Hunting/Incident Response → Cloud Security → Compliance/Governance. |

## 3. Design Track

| Track | Core Progression |
| :--- | :--- |
| **UX Design** | Human Behavior/Psychology → User Research/Personas → Business Model Analysis → Conceptual Design/Flowcharts → Prototyping (Figma/Sketch) → UX Patterns/Best Practices → A/B Testing & Measurement. |

## Guiding Principles

1. **Foundation First**: Master basics (Python, SQL, JavaScript) before advanced topics.
...
- https://roadmap.sh/python-data-analysis
